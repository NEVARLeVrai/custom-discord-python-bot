...
class Help_slash(commands.Cog):
    ...
    def create_help_embeds(self, user: discord.User):
        ...
        embed4 = discord.Embed(title=t('help_music_title'), description=t('help_music_desc'), color=discord.Color.random())
        embed4.set_author(name=t('help_requested_by', user=user.name), icon_url=user.avatar)
        embed4.add_field(name="mplay", value=t('help_mplay_desc'))
        embed4.add_field(name="msearch", value=t('help_msearch_desc'))
        embed4.add_field(name="mskip", value=t('help_mskip_desc'))
        embed4.add_field(name="mstop", value=t('help_mstop_desc'))
        embed4.add_field(name="mpause", value=t('help_mpause_desc'))
        embed4.add_field(name="mresume", value=t('help_mresume_desc'))
        embed4.add_field(name="mqueue", value=t('help_mqueue_desc'))
        embed4.add_field(name="mclearqueue", value=t('help_mclearqueue_desc'))
        embed4.add_field(name="mloop", value=t('help_mloop_desc'))
        embed4.add_field(name="mprevious", value=t('help_mprevious_desc'))
        embed4.add_field(name="maddqueue", value=t('help_maddqueue_desc'))
        embed4.add_field(name="mremovequeue", value=t('help_mremovequeue_desc'))
        embed4.add_field(name="mseek", value=t('help_mseek_desc'))
        embed4.add_field(name="mvolume", value=t('help_mvolume_desc'))
        embed4.add_field(name="mleave", value=t('help_mleave_desc'))
        embed4.add_field(name=t('help_music_controls_title'), value=t('help_music_controls_desc'), inline=False)
        ...
        embed5.add_field(name="svolume", value=t('help_svolume_desc'))
